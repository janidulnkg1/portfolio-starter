...
const Banner = () => {
  ...
  <section id='home' className='section'>
    <div className='container mx-auto mt-10'>
        ...
        <p>Hi I'm Janidu Lankage, a final year undergraduate following BSc (Hons) Software Engineering, awarded by Cardiff Metropolitan University, UK. <br></br>
                  ...
                  Mobile Development: Android (Java/ Kotlin) <br></br>
                  Machine learning, Artificial intelligence, Analytics: TensorFlow, PyTorch, Yolo V8, RStudio. <br></br>
