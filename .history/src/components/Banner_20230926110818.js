            ...
            <div>
              ...
              <div className='mb-6 text-[36px] lg:text-60px font-secondary
                ...
                <p>I'm a final year undergraduate following BSc (Hons) Software Engineering. 
                  I'm a passionate software engineer with expertise in backend (C#: .Net Core, ASP.Net Core; Java : Springboot / Hibernate etc.) and frontend technologies (HTML5, CSS3, JavaScript: JQuery/ AJAX, php, React.js/Typescript etc.) 
